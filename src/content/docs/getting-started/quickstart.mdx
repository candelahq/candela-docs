...
:::tip[What's next?]
- [Configure cloud models](/candela-docs/components/candela-local/) in Solo + Cloud mode
- [Deploy to production](/candela-docs/components/candela-sidecar/) with candela-sidecar
- [Integrate with Google ADK](/candela-docs/guides/adk-integration/) for distributed tracing
:::
