...
<Tabs>
  <TabItem label="Solo Developer">
    ...
    [candela-local docs →](/candela-docs/components/candela-local/)
  </TabItem>
  <TabItem label="Team / Production">
    ...
    [candela-server docs →](/candela-docs/components/candela-server/)
  </TabItem>
  <TabItem label="Container Sidecar">
    ...
    [candela-sidecar docs →](/candela-docs/components/candela-sidecar/)
  </TabItem>
  <TabItem label="Google ADK">
    ...
    [ADK Integration →](/candela-docs/guides/adk-integration/)
  </TabItem>
</Tabs>

## Next Steps

<LinkCard title="Installation" description="Install any Candela component from the monorepo." href="/candela-docs/getting-started/installation/" />
<LinkCard title="Quick Start" description="Send your first traced LLM request in under 5 minutes." href="/candela-docs/getting-started/quickstart/" />
