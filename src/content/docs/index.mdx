...
template: splash
hero:
  tagline: "Know what your AI costs. Every model, every session, every dollar — tracked in real time. Set up in 60 seconds."
  image:
...
3. **See your costs**
   ```bash
   # Point any AI tool at localhost:8181
   # Or install the OpenCode plugin:
   opencode plugin @candelahq/opencode
   ```
</Steps>

[![GitHub stars](https://img.shields.io/github/stars/candelahq/candela?style=social)](https://github.com/candelahq/candela)
