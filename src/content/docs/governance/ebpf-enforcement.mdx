...
| 6 | Tetragon + Hubble observability integration | <Badge text="Shipped" variant="success" /> |
| 6a | Tetragon gRPC audit hardening (`CloseSend`, `MultiSink`, graceful shutdown) | <Badge text="Shipped" variant="success" /> |
