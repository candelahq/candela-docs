...
For the full list of models with built-in pricing, see [`pkg/costcalc/pricing.yaml`](https://github.com/candelahq/candela/blob/main/pkg/costcalc/pricing.yaml). Models not in this list still work — they first resolve through Firestore Catalog or config overrides; otherwise they report cost as $0.00 until you add pricing data.
:::
